...
class BaseContract:
    """
    Conceptual Base Smart Contract in Python.
    """
...
class DerivedContract(BaseContract):
    ...
    def use_base_internal(self, x, y):
        print("DerivedContract: Calling base internal helper...")
...
class MyERC20Token(AbstractERC20Token):
    ...
    def __init__(self, initial_supply, token_name, token_symbol):
        ...
        print("MyERC20Token (concrete) fully initialized.")
...
my_token.transfer(addr1, addr2, 500)  # Fail case
